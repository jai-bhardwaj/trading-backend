...
import pytest
import pandas as pd
from ..strategies import Strategy, MovingAverageCrossoverAngelOne
...
def test_moving_average_crossover_creation():
    ...
    ma_strategy = MovingAverageCrossoverAngelOne(short_period=10, long_period=20, lot_size=100)
...
def test_moving_average_crossover_signals():
    ...
    data.index = pd.to_datetime(['2024-01-01', '2024-01-02', '2024-01-03', '2024-01-04', '2024-01-05',
...
def test_moving_average_crossover_signals_error():
    ...
    data.index = pd.to_datetime(['2024-01-01', '2024-01-02', '2024-01-03', '2024-01-04', '2024-01-05',
                                '2024-01-06', '2024-01-07', '2024-01-08', '2024-01-09', '2024-01-10'])
    ma_strategy = MovingAverageCrossoverAngelOne(short_period=3, long_period=5)
    with pytest.raises(ValueError, match="Input DataFrame must contain a 'Close' column."):
